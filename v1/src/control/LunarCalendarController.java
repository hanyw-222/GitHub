...
public class LunarCalendarController {
    ...
    /*** 将农历日期转换为公历日期* @param year                        农历年份* @param month                        农历月* @param monthDay                农历日* @param isLeapMonth        该月是否是闰月* [url=home.php?mod=space&uid=7300]@return[/url] 返回农历日期对应的公历日期，year0, month1, day2.*/
        ...
        for (i = 1; i < 13; i++) {
            ...
            if (iPos >= dayOffset) {
                ...
                if (dayOffset > iPos) solarInfo[2] = dayOffset - iPos;
                    ...
                    if (year % 4 == 0 && i == 2) solarInfo[2] = DAYS_BEFORE_MONTH[i] - DAYS_BEFORE_MONTH[i - 1] + 1;
    ...
    /*public static void main(String[] args) throws Exception{
        ...
        int month = 12;
        int day = 30;
        LunarCalendarController l1 = new LunarCalendarController();
        l1.ReturnTimeStamp(year, month, day);
