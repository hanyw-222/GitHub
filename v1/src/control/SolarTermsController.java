...
public class SolarTermsController {

    String year = null;

    public SolarTermsController(String year) {
        this.year = year;
    }
    ...
    public String getSpring() {
        ...
        String[] season = solarTermToString(count);
        try {
            String string = season[0];
            String checkString = null;
            if (string.substring(4).length() == 5) {
                checkString = string.substring(4, 7) + "0" + string.substring(7);
            }


            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy年MM月dd日");
            Date date = simpleDateFormat.parse(year + "年" + checkString);
...
//注意：凡闰年3月1日前闰年数要减一，即：L=[(Y-1)/4],因为小寒、大寒、立春、雨水这两个节气都小于3月1日,所以 y = y-1
    ...
    public static String[] solarTermToString(int year) {
        ...
        sb.append("\n").append("立春：02月").append(getSolarTermNum(year, SolarTermsEnum.LICHUN.name()))
                ...
                .append("日,\n立夏:05月").append(getSolarTermNum(year, SolarTermsEnum.LIXIA.name()))
                ...
                .append("日,\n立秋:08月").append(getSolarTermNum(year, SolarTermsEnum.LIQIU.name()))
                ...
                .append("日,\n立冬:11月").append(getSolarTermNum(year, SolarTermsEnum.LIDONG.name()))
                ...
                .append("日,\n清明:04月").append(getSolarTermNum(year, SolarTermsEnum.QINGMING.name()))
                .append("日");
        seasons = sb.toString().split(",");
    ...
    /*public static void main(String[] args) {
        ...
        SolarTermsController solarTermsController=new SolarTermsController("2019");

        String spring =solarTermsController.getSummer();
