...
<div class="span12  center-block">
    ...
    <table id="courseTable">
        <tr>
            ...
            <th style="width: 50%">课程内容</th>
            <th style="width: 20%">操作</th>
        </tr>
    </table>
    <br>
    <div class="subtitle">
        <button class="div_btn" style="color: white;background-color: #5cb85c" onclick="queryCourse(1)">首页</button>
        <button class="div_btn" style="color: white;background-color: #5cb85c" onclick="queryCourse(2)">上一页</button>
        <span class="div_btn" id="showInfo" style="color: black"> 第 1 页 / 共 1 页 </span>
        <button class="div_btn" style="color: white;background-color: #5cb85c" onclick="queryCourse(3)">下一页</button>
        <button class="div_btn" style="color: white;background-color: #5cb85c" onclick="queryCourse(4)">末页</button>
    </div>
</div>
